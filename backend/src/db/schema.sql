...
-- See docs/DATABASE.md for the annotated entity-relationship explanation.
...
CREATE INDEX IF NOT EXISTS idx_beneficiaries_linked_user ON beneficiaries(linked_user_id);
...
CREATE INDEX IF NOT EXISTS idx_trusted_contacts_linked_user ON trusted_contacts(linked_user_id);
...
CREATE INDEX IF NOT EXISTS idx_legacy_messages_beneficiary ON legacy_messages(beneficiary_id);
CREATE INDEX IF NOT EXISTS idx_legacy_messages_release_scan ON legacy_messages(status, release_type, release_at);
